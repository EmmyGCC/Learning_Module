...
/*   Tip: To avoid modifying this file each time you need to switch between these
  ...
  - Low-Density STM8S devices are the STM8S103xx, STM8S003 and STM8S903xx microcontrollers
    ...
    !defined (STM8S003)&& !defined (STM8S005) && !defined (STM8AF622x) && !defined (STM8S001)
...
#define I2C ((I2C_TypeDef *) I2C_BaseAddress)
    ...
    defined(STM8S003) ||defined(STM8S903) || defined (STM8AF52Ax) || defined (STM8AF62Ax)|| defined(STM8S001)
...
#define TIM1 ((TIM1_TypeDef *) TIM1_BaseAddress)
    ...
    defined (STM8AF62Ax) || defined (STM8AF626x) || defined(STM8S001)
