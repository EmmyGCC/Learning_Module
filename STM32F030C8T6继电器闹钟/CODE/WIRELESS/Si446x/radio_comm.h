...
#define RADIO_CTS_TIMEOUT 30000
...
void radio_comm_ReadData(U8 cmd, _Bool pollCts, U8 byteCount, U8* pData);
void radio_comm_WriteData(U8 cmd, _Bool pollCts, U8 byteCount, U8* pData);
